    ...
    if(isset($data['message'])) {
        ...
        switch($callback) {
            ...
            case "give_superimposes":
                sendMessage([
                    "chat_id" => $chat_id,
                    "text" => "Для оформления заказа наложенным платежом, напишите нашему <a href='https://t.me/mhmr_shop_operator'>оператору</a>:\n\nДля правильного оформления заказа заполните эту форму по пунктам, чтобы наш оператор смог оформить его вручную (нажмите на текст ниже, чтобы его скопировать):\n\n<code>1. Список товаров для покупки - ...\n2. Служба доставки (оставить нужное) - CDEK, Почта России\n3. ФИО получателя - ...\n4. Email - ...\n5. Город и ТОЧНЫЙ адрес пункта выдачи - ...\n6. Номер телефона получателя - ... </code>\n\n! Если вы выбираете доставку наложенным платежом, к стоимости заказа добавится комиссия, равная стоимости доставки.",
                    "parse_mode" => "html",
                    "reply_markup" => json_encode([
                        "inline_keyboard" => [
                            [
